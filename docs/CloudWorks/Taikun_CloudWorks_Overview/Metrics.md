...
* [Prometheus](https://prometheus-operator.dev/docs/getting-started/design/#prometheus)

* [Alertmanager](https://prometheus-operator.dev/docs/getting-started/design/#alertmanager)

* [ThanosRuler](https://prometheus-operator.dev/docs/getting-started/design/#thanosruler)

* [ServiceMonitor](https://prometheus-operator.dev/docs/getting-started/design/#servicemonitor)

* [PodMonitor](https://prometheus-operator.dev/docs/getting-started/design/#podmonitor)

* [Probe](https://prometheus-operator.dev/docs/getting-started/design/#probe)

* [PrometheusRule](https://prometheus-operator.dev/docs/getting-started/design/#prometheusrule)

* [AlertmanagerConfig](https://prometheus-operator.dev/docs/getting-started/design/#alertmanagerconfig)

* [PrometheusAgent](https://prometheus-operator.dev/docs/getting-started/design/#prometheusagent)
...
Further information can also be found in the [Thanos section](https://prometheus-operator.dev/docs/platform/thanos/).
...
!!! Note
	`endpoints` (lowercase) is the field in the `ServiceMonitor` CRD,
	
	while `Endpoints` (capitalized) is the Kubernetes object kind.
