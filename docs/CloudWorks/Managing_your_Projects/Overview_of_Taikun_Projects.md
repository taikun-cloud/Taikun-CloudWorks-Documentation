...
- **Failure**: One or more components in the pipeline failed to deploy (for example, a server during booting, a service during creation, or due to an unsuccessful deployment).
