...
!!! Note
	The Taikun CloudWorks connection utilizes a self-hosted version of AI Assistance. Your data won’t be sent to OpenAI for processing when choosing these credentials.
...
1. **Open any Project** within your Taikun CloudWorks account.
...
4. **Specify the set of AI Credentials** you’d like to use in your Project (Taikun CloudWorks is the default connection that is self-hosted by the Taikun CloudWorks team).
...
Users of Taikun CloudWorks can also connect their own OpenAI account to receive AI assistance directly within the application. To connect your AI Assistant, follow these steps:
