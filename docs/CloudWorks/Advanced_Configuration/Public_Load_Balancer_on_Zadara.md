...
When deploying applications on [**Zadara Cloud**](https://docs.taikun.cloud/CloudWorks/Supported_Cloud_Providers/Zadara/) through **Taikun CloudWorks**, it is important to configure your service to be accessible online, particularly for public-facing applications. For platforms like AWS, this is typically done with the following annotation:
...
By configuring your Kubernetes service with the correct annotations and settings, Zadara will allocate a public-facing IP address to your service, making it accessible over the internet. It’s important to consult Zadara Cloud and Taikun CloudWorks documentation to ensure you’re using the correct setup for your load balancer and external IP assignment.
