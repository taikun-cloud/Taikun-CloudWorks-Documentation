...
* [`filter_scheduler.aggregate_image_properties_isolation_separator`](https://docs.openstack.org/nova/zed/configuration/config.html#filter_scheduler.aggregate_image_properties_isolation_separator)
